...
ActiveRecord::Schema.define(:version => 20140707091846) do
  ...
  create_table "askquestions", :force => true do |t|
    t.string   "question"
    t.string   "type"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "quereys", :force => true do |t|
    t.string   "subject"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
    t.integer  "grade"
